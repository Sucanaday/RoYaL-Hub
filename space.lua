...
KeySystemUI.New({
    ApplicationName = "RoYaLHub", -- Your Key System Application Name
    Name = "RoYaL Hub", -- Your Script name
...
TOTEXT.Text = "Not Support :("
  ...
  Notif.New("Please Join Discord: discord.gg/RoYaL Hub For More Supported Games :3", 10)
end
...
DISTEXT.Text = "Discord: https://discord.gg/RoYaLhub"
...
CoppyDis.MouseButton1Click:Connect(function()
	if click == false then
		click = true
    pcall(function()
		  setclipboard("https://discord.gg/RoYaLhub")
	  end)
